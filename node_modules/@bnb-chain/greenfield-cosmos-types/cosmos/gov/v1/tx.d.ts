...
export declare const MsgUpdateCrossChainParams: {
    ...
    fromPartial<I extends {
        ...
        params?: ({
            ...
            key?: string | undefined;
            values?: (string[] & string[] & Record<Exclude<keyof I["params"]["values"], keyof string[]>, never>) | undefined;
            targets?: (string[] & string[] & Record<Exclude<keyof I["params"]["targets"], keyof string[]>, never>) | undefined;
        } & Record<Exclude<keyof I["params"], keyof CrossChainParamsChange>, never>) | undefined;
