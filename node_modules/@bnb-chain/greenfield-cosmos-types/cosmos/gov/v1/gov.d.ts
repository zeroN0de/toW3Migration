...
export declare const CrossChainParamsChange: {
    ...
    fromPartial<I extends {
        ...
        key?: string | undefined;
        values?: (string[] & string[] & Record<Exclude<keyof I["values"], keyof string[]>, never>) | undefined;
        targets?: (string[] & string[] & Record<Exclude<keyof I["targets"], keyof string[]>, never>) | undefined;
