...
exports.StakeAuthorization = {
    ...
    fromJSON(object) {
        return {
            ...
            authorizationType: (0, helpers_1.isSet)(object.authorizationType) ? authorizationTypeFromJSON(object.authorizationType) : 0
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromSDK(object) {
        return {
            ...
            authorizationType: (0, helpers_1.isSet)(object.authorization_type) ? authorizationTypeFromJSON(object.authorization_type) : 0
        };
    },
    toSDK(message) {
        const obj = {};
