...
exports.ModuleSchemaDescriptor_FileEntry = {
    ...
    fromJSON(object) {
        return {
            ...
            storageType: (0, helpers_1.isSet)(object.storageType) ? storageTypeFromJSON(object.storageType) : 0
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromSDK(object) {
        return {
            ...
            storageType: (0, helpers_1.isSet)(object.storage_type) ? storageTypeFromJSON(object.storage_type) : 0
        };
    },
    toSDK(message) {
        const obj = {};
