...
exports.FileOptions = {
    ...
    fromSDK(object) {
        return {
            ...
            optimizeFor: (0, helpers_1.isSet)(object.optimize_for) ? fileOptions_OptimizeModeFromJSON(object.optimize_for) : 0,
...
exports.MethodOptions = {
    ...
    fromSDK(object) {
        return {
            deprecated: object?.deprecated,
            idempotencyLevel: (0, helpers_1.isSet)(object.idempotency_level) ? methodOptions_IdempotencyLevelFromJSON(object.idempotency_level) : 0,
            uninterpretedOption: Array.isArray(object?.uninterpreted_option) ? object.uninterpreted_option.map((e) => exports.UninterpretedOption.fromSDK(e)) : []
        };
    },
    toSDK(message) {
